...
class Controller_Contact extends Controller_Basic_Template {
...
//		var_dump($segment_info_get_array);
		...
		// CSSセット
//		$this->basic_template->view_data["external_css"] = View::forge('contact/externalcss');

		// コンテンツデータセット
		$this->basic_template->view_data["content"]->set('content_data', array(
			'value' => View::forge('contact/content'),
		), false);
